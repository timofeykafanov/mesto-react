        ...
        <main className="content">
            <section className="profile">
                <div className="profile__person">
                    <div className="profile__avatar" onClick={props.onEditAvatar} style={{ backgroundImage: `url(${props.avatar})` }}></div>
            ...
            <section className="elements">
                {props.cards.map(card => <Card key={card._id} {...card} onCardClick={props.onCardClick} />)}
            </section>
        </main>
    )
}
